...
const ProfilePage = () => {
  ...
  const deleteImage = () =>{
    updateProfile({profilePic: "removeIt"})
  }

  return (
    <div className=" h-screen pt-20 max-2-2xl mx-auto p-4 py-8 w-2/5">
      <div className="bg-base-300 rounded-xl p-6 space-y-8">
        ...
        <div className="flex flex-col items-center gap-4" >
          ...
          <div className="relative">
            ...
            <button type="button" className="btn btn-xs btn-outline btn-warning" onClick={deleteImage}>Delete photo</button>
          </div>
